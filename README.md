...
This repository contains the work I have developed during the Software Engineering course. It includes the laboratory assignments completed during the semester, the Software Requirements Specification (SRS) of the Gym Management System, and the project folder with the updated diagrams created for that system as the course progressed.
...
These diagrams represent the interactions between the actors and the system, showing the main functionalities of the Gym Management System and how users interact with them.

Some of the main concepts worked on in this lab are:
- actors
- use cases
- system boundary
- `<<include>>`
...
These diagrams represent the static structure of the system and the relationships between the main classes of the Gym Management System.
...
This folder includes examples and updated versions of the diagrams created for the system throughout the semester. It contains the project work that was improved week by week as new laboratory activities were completed.

Typical contents of this folder include:
- use case diagrams
- class diagrams
- behavioral diagrams
- updated versions of the system models
